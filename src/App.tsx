  ...
  const sharedInputBox = (
    <div className="input-box" id="shared-input-box">
      ...
      <input
        ...
        value={input}
        onChange={(event) => {
          if (!isGenerating) setInput(event.target.value)
        }}
        onKeyDown={(event) => {
          if (event.key === 'Enter' && !actionDisabled && !isGenerating) {
            handleSend()
          }
        }}
      />
  ...
  return (
    <>
      ...
      <div className="main-wrapper">
        ...
        <main className="content-area" id="content-area" ref={contentAreaRef}>
          <div
            className="welcome-container"
            id="welcome-screen"
            style={{ display: activeSession ? 'none' : 'flex' }}
          >
            <h1 className="welcome-title">Ready to get started?</h1>

            <div className="welcome-input-host" id="welcome-input-host">
              {!activeSession && sharedInputBox}
            </div>
          </div>
          ...
          <div
            ...
            id="chat-container"
            style={{ display: activeSession ? 'flex' : 'none' }}
          >
            ...
            {isGenerating && activeSession && currentChatId === activeSession.id && (
